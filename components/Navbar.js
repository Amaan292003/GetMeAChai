  ...
  return (
    <nav className='bg-blue-950 text-white flex flex-col md:flex-row justify-between px-4 md:h-14 items-center'>
      <Link className='logo font-bold text-lg flex justify-center items-center' href={"/"}>
        ...
        <Image src="/tea.svg" width={52} height={52} className='pb-2 invertImg' alt="Chai logo" />
      </Link>

      <div className='relative flex mt-12 mb-4 md:mb-0 md:mt-0 gap-8 justify-center items-center md:block md:gap-4'>
        {session && <>
          <div className="flex justify-center bottom-14 md:bottom-1 items-center absolute md:right-[208px] md:top-[4px]">
            <Image onClick={handleclick} src="/hover.gif" width={24} height={22} className="absolute md:top-[4px] top-[6px] md:right-[250px] right-[210px]" alt="Search icon" />
